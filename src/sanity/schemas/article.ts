...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      options: { list: [
        { title: 'El Perro Glotón', value: 'perro-gloton' },
        { title: 'Perro Milpero', value: 'perro-milpero' },
        { title: 'Pata de Perro', value: 'pata-de-perro' },
        { title: 'Buen Olfato', value: 'buen-olfato' },
        { title: 'Perro de Barrio', value: 'perro-de-barrio' },
        { title: 'Huella Local', value: 'huella-local' },
      ] },
